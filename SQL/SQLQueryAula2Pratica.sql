...
/*Se eu quero apenas os lientes do sexo masculino?*/
...
/*Indo mais adiante, se seu chefe pede um relatorio dos clientes do sexo feminino acima de 30 anos que
seja ordenado da pessoa mais velha a mais nova.*/
...
/*Ordenar os funcionarios por ordem de nascimento*/
...
SELECT sexo, AVG (salario) AS media_salario,COUNT (ID) AS qtn_sexo
FROM funcionarios
GROUP BY sexo;